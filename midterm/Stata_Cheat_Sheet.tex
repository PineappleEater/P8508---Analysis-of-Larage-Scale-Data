...
\fancyfoot[C]{\fontsize{6pt}{6pt}\selectfont \thepage}
\fancyfoot[R]{\fontsize{5pt}{5pt}\selectfont Stata Cheat Sheet}
...
% Title
\begin{center}
     \fontsize{10pt}{10pt}\selectfont\textbf{Stata Cheat Sheet} \\
     \fontsize{5.5pt}{5.5pt}\selectfont Large Scale Data - Part 2
