...
% Title
\begin{center}
     \fontsize{13pt}{13pt}\selectfont\textbf{Stata Cheat Sheet} \\
     \fontsize{6.5pt}{6.5pt}\selectfont Large Scale Data - Part 2
\end{center}\vspace{-0.2cm}

% -----------------------------------------------------------------------
\section{Example Dataset: Hospital Discharge Data}
...
\item \textbf{Geographic:} Multiple counties with county-level socioeconomic data
\item \textbf{Outcome:} Total costs (continuous), expensive stay flag (binary)
\item \textbf{Key coding challenges:} Missing values (999/9999), top-coding of costs, string variables (county names)
